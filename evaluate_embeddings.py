...
#
# Script to evaluate embeddings using numpy data and language things.
#
...
from utils import Titler, LangEmbedding, wiki_dirs
...
def get_crosslingual_wordsim_scores(lang1, word2id1, embeddings1,
    ...
    logging.info(pattern % (task_name, str(found), str(not_found), "%.4f" % coeff))
